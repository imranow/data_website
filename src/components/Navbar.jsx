...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-20 max-w-[1240px] mx-auto px-8 text-white">
      ...
      >
        ...
        <ul className="uppercase p-4">
          ...
          <li className="p-4 border-b border-green-300">Company</li>
          <li className="p-4 border-b border-green-300">Resources</li>
